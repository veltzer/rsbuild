...
produces a cached success marker, allowing RSB to skip re-linting when source files haven't changed.
...
When any tracked file changes, rsb will re-run clippy.
